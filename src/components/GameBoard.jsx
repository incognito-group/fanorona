...
export default function GameBoard({ board, selectedPiece, onNodeClick }) {
  return (
        ...
        {board.map((cell, index) => (
          <div key={index} className="flex items-center justify-center">
            <button
              ...
              className={`relative z-10 w-10 h-10 rounded-full border transition-all duration-150 flex items-center justify-center text-[10px] font-mono
